...
package org.mendora.facade.data.mongo.rxjava;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link org.mendora.facade.data.mongo.MongoAccesser original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(org.mendora.facade.data.mongo.MongoAccesser.class)
public class MongoAccesser {
  ...
  public static final io.vertx.lang.rxjava.TypeArg<MongoAccesser> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new MongoAccesser((org.mendora.facade.data.mongo.MongoAccesser) obj),
    MongoAccesser::getDelegate
  );

  private final org.mendora.facade.data.mongo.MongoAccesser delegate;

  @Inject
  public MongoAccesser(org.mendora.facade.data.mongo.MongoAccesser delegate) {
    this.delegate = delegate;
  }

  public org.mendora.facade.data.mongo.MongoAccesser getDelegate() {
    return delegate;
  }
  ...
  public static  MongoAccesser newInstance(org.mendora.facade.data.mongo.MongoAccesser arg) {
