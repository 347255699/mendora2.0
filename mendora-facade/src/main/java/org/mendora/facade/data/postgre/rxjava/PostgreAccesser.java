...
package org.mendora.facade.data.postgre.rxjava;
 ...
 *
 * <p/>
 * NOTE: This class has been automatically generated from the {@link org.mendora.facade.data.postgre.PostgreAccesser original} non RX-ified interface using Vert.x codegen.
 */

@io.vertx.lang.rxjava.RxGen(org.mendora.facade.data.postgre.PostgreAccesser.class)
public class PostgreAccesser {
  ...
  public static final io.vertx.lang.rxjava.TypeArg<PostgreAccesser> __TYPE_ARG = new io.vertx.lang.rxjava.TypeArg<>(
    obj -> new PostgreAccesser((org.mendora.facade.data.postgre.PostgreAccesser) obj),
    PostgreAccesser::getDelegate
  );

  private final org.mendora.facade.data.postgre.PostgreAccesser delegate;

  @Inject
  public PostgreAccesser(org.mendora.facade.data.postgre.PostgreAccesser delegate) {
    this.delegate = delegate;
  }

  public org.mendora.facade.data.postgre.PostgreAccesser getDelegate() {
    return delegate;
  }
  ...
  public static  PostgreAccesser newInstance(org.mendora.facade.data.postgre.PostgreAccesser arg) {
