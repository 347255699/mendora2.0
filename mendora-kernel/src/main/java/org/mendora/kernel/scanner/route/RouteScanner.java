...
public class RouteScanner {
    ...
    private void launchHttpServer() {
        String webServerPort = config.property(Const.WEB_LISTEN_PORT);
        log.info("all the \"routes\" deployed");
        ...
        log.info("web server listenning at port:{}", webServerPort);
    }
    ...
    public void scan(String packagePath, Injector injector) {
        List<String> names = new PackageScannerImpl(packagePath, injector.getInstance(ClassLoader.class)).classNames();
